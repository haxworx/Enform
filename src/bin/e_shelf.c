...
e_shelf_style_set(E_Shelf *es, const char *style)
{
   ...
   if (!strcmp(style, "invisible")) {
	/* Better shelf */
	evas_object_color_set(es->o_base, 255, 255, 255,  192);
	evas_object_color_set(es->o_event, 0, 0, 0,  128);
   } else {
	evas_object_color_set(es->o_base, 255, 255, 255,  255);
	evas_object_color_set(es->o_event, 255, 255, 255, 255);
   }
