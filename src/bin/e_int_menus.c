...
static void         _e_int_desklock_show(void *data, E_Menu *m, E_Menu_Item *mi);
...
static void _e_int_menus_exec(void *data __UNUSED__, E_Menu *m __UNUSED__, E_Menu_Item *mi __UNUSED__);
...
e_int_menus_main_new(void)
{
   ...
   mi = e_menu_item_new(m);
   e_menu_item_label_set(mi, _("Exec..."));
   e_menu_item_callback_set(mi, _e_int_menus_exec, NULL);
   ...
   mi = e_menu_item_new(subm);
   e_menu_item_label_set(mi, _("Lock"));
   e_util_menu_item_theme_icon_set(mi, "system-lock-screen");
   e_menu_item_callback_set(mi, _e_int_desklock_show, NULL);
...
static void
_e_int_menus_exec(void *data __UNUSED__, E_Menu *m __UNUSED__, E_Menu_Item *mi __UNUSED__)
{
	e_exec_show();
}
...
static void
_e_int_desklock_show(void *data __UNUSED__, E_Menu *m __UNUSED__, E_Menu_Item *mi __UNUSED__)
{
  E_Action *a = e_action_find("e_desklock_show");
